 ...
 */
export function buildChatCompletion(content, modelName, reasoningContent, conversationUrl) {
    const message = {
        role: 'assistant',
        content: content
    };
    ...
    if (conversationUrl) {
        result.conversation_url = conversationUrl;
    }
    return result;
}
 ...
 */
export function buildChatCompletionChunk(content, modelName, finishReason = 'stop', reasoningContent, conversationUrl) {
    const delta = { content };
    if (reasoningContent) {
