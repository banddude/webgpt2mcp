...
if (!BASE) throw new Error('PUBLIC_BASE is required, e.g. https://chatgpt-mcp.example.com');
const RESOURCE = `${BASE}/mcp`;
const UPSTREAM = process.env.UPSTREAM || 'http://127.0.0.1:17842/mcp';
const STORE_FILE = process.env.OAUTH_STORE || new URL('./data/oauth-store.json', import.meta.url).pathname;
const ADMIN_FILE = process.env.ADMIN_TOKEN_FILE || new URL('./data/oauth-admin-token', import.meta.url).pathname;
